...
<head>
    ...
    <title>PQRS - FUNDACION FUNDAESCOL</title>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="#" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="pqrs_type" class="form-label">Tipo de Solicitud</label>
                                <select class="form-select" id="pqrs_type" name="pqrs_type" required>
